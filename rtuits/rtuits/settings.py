# Django settings for resum1 project.
...
#SITE_ID = 1
SITE_ID=u'53781e4b4e71e32579208764'
...
SECRET_KEY = 'r3q+(ifm*tih&!gr7(yi!$ze-2%da%&s_3_ya-o(9_^^rnxpdc'
...
#ROOT_URLCONF = 'resum1.urls'
ROOT_URLCONF = 'rtuits.urls'

# Python dotted path to the WSGI application used by Django's runserver.
#WSGI_APPLICATION = 'resum1.wsgi.application'
